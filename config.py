...
# high_pass_filter = 200  # High pass filter used. To choose between [0.7, 10, 100, 200] Hz
...
# Second input configuration (erase if only one input configuration is wanted)
# used_input = 'MULT_IN2'  # Input to configure --> Copy string from list of used inputs
...
byte_config = cf.config_to_byte(inputs_config, byte_config)  # Send configuration to amplifier
